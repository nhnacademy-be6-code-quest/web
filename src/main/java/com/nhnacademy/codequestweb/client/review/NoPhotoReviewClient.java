...
@FeignClient(name = "noPhotoReviewClient", url = "http://localhost/no-photo-reviews")
//@FeignClient(name = "noPhotoReviewClient", url = "http://10.220.222.13:8001/no-photo-reviews")
